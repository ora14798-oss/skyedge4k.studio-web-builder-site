...
const DATA = [
  {
    ...
    description:
      "Get deep insights into your business performance with real-time data.",
    icon: CircleHelp,
    image:
  ...
  },
  {
    ...
    description:
      "Streamline your processes with intelligent automation and save time.",
    icon: Volume2,
    image:
  ...
  },
  {
    ...
    description:
      "Monitor everything that matters with live updates and notifications.",
    icon: Lightbulb,
    image:
...
const FeaturesSection = () => {
  return (
    <section id="features" className="py-32 max-w-7xl mx-auto">
      <div className="">
        <div className=" max-w-7xl mx-auto flex flex-col gap-6  py-4 max-lg:border-x lg:py-8">
          ...
          >
            ...
            <span className="">Powerful Features</span>
          </Badge>
