      ...
      <div className="w-full items-center px-[10px]">
        ...
        <nav className="hidden items-center justify-between lg:flex">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Link href={auth.quote.url} dir="auto">{auth.quote.title}</Link>
            </Button>
          </div>
        </nav>
